            ...
            <li class="nav-item mb-1">
                <a href="{{ route('admin-staff.dashboard') }}"
                    class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 transition
                       {{ request()->routeIs('admin-staff.dashboard') ? 'bg-primary text-white fw-semibold' : 'text-dark hover-bg-light' }}">
                    <i class="bi bi-house-door"></i> Dashboard
                </a>
            </li>

            <li class="nav-item mb-1">
                <a href="{{ route('admin-staff.booking-management') }}"
                    class="nav-link d-flex align-items-center gap-2 rounded px-3 py-2 transition
        {{ request()->routeIs('admin-staff.booking-management') || request()->routeIs('admin-staff.vehicle-booking-management') ? 'bg-primary text-white fw-semibold' : 'text-dark hover-bg-light' }}">
