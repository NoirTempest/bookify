<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex mt-4">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <div class="d-none d-sm-flex gap-3">
                        <div x-data="{ name: @js(auth()->user()->full_name) }"
                            x-html="`<strong>${name}</strong> Dashboard`"
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <span x-data="{ name: @js(auth()->user()->full_name) }" x-text="name"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800" x-data="{ name: @js(auth()->user()->name) }"
