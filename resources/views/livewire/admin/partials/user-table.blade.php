<div id="userTableWrapper" class="card shadow-sm border-0">
    {{-- Table Header --}}
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const input = wrapper.querySelector("#userSearchInput");
        const tableBody = wrapper.querySelector("#userTableBody");
