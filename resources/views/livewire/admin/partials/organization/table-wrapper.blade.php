<div id="orgTableWrapper_{{ $key }}" class="card shadow-sm border-0 mt-3">
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        const input = document.querySelector("#searchInput_{{ $key }}");
        const tableBody = document.querySelector("#tableBody_{{ $key }}");
