<div id="departmentTableWrapper" class="card shadow-sm border-0 mt-3">
    <!-- Header -->
        ...
        <table class="table table-hover mb-0 align-middle" style="border-collapse: separate; border-spacing: 0 0.6rem;">
            ...
            <tbody id="departmentTableBody">
                ...
                <tr class="searchable-row"
                    ...
                    <td class="ps-4">{{ $departments->firstItem() + $index }}</td>
                    <td>{{ $item->name }}</td>
...
<script>
    ...
    noResultsRow.innerHTML =
        `<td colspan="4" class="text-center text-muted py-4">No matching records found.</td>`;
